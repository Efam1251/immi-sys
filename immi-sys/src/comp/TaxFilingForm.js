...
const url_form = API_ROUTES.TAX_FILING_FORM;
...
const dropdownFieldConfigs = [
  ...
  {
    key: "filingStatus",
    dropdownUrl: API_ROUTES.TAX_FILING_STATUS_LIST,
    modalUrl: null,
  },
  {
    key: "status",
...
const TaxFilingForm = () => {
  ...
  const modalReference = `${formData.customer?.socialSecurity || "N/A"}-${
    formData.taxYear || "0000"
  }`;
  ...
  return (
    <div className="form-container">
      ...
      <DocumentModal
        ...
        type={DOCUMENT_TYPE.TAX_DOCUMENT}
      />
      <MessagePopup
        message={message}
